...
import by.epam.learn.main.tasks6.exception.NullFacultyException;
import by.epam.learn.main.tasks6.exception.NullGroupException;
import by.epam.learn.main.tasks6.exception.NullStudentException;
import by.epam.learn.main.tasks6.exception.WrongMarkException;
import by.epam.learn.main.tasks6.util.StudentUtil;

import java.util.Arrays;
import java.util.HashMap;
import java.util.List;

import static by.epam.learn.main.tasks6.util.ValidationUtil.*;
import static by.epam.learn.main.tasks6.Subject.*;
import static by.epam.learn.main.tasks6.Subject.CHEMISTRY;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subject searchSubject = Subject.ECONOMETRICS;

        String faculty = Faculty.FACULTY_OF_ECONOMICS.name();
        String group = Group.FULL_TIME_815.name();
        String specificSubject = Subject.ECONOMETRICS.name();
        try {
